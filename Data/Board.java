...
public class Board {
	...
	/**
	 * Liste des fruits (qui contient les fruits déjà  plaçables) du plateau.
	 */
	 ...
	 * @return Chaîne de caractère correspondant au contenu du fichier texte.
	 */
	...
	/**
	 * Convertit un fichier texte contenant la synthèse des éléments du plateau à  initialiser en une matrice exploitable.
	 * @param path_map Chemin d'accès du fichier texte contenant la synthèse des éléments du plateau à  initialiser.
	...
	public Board(int level) {
		System.out.println(String.format("Niveau %d:", level));
	...
	/**
	 * Renvoie la liste des fruits générée à lag construction.
	 * @return La liste des fruits déjà  plaçables sur le plateau.
	 */
